...
# Install .net - These two lines look broken. Need to review this.
# Dism /online /Enable-feature /featurename:NetFx3 /All
# Get-AppxPackage -allusers Microsoft.NET.* | Foreach {Add-AppxPackage -DisableDevelopmentMode -Register â€œ$($_.InstallLocation)\AppXManifest.xmlâ€}
